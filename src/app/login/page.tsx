        ...
        <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
            ...
            {mode===MODE.REGISTER ? (
                <div className="flex flex-col gap-2">
                    <label className="text-sm text-gary-700">Username</label>
                    <input
                     type="text"
                      name="username"
                       placeholder="priya" 
                ...
                <div className="flex flex-col gap-2">
                    <label className="text-sm text-gary-700">E-mail</label>
                    <input
                     type="email"
                      name="email" 
                      placeholder="rajpriya4439@gmail.com"
                       className="ring-2 ring-gray-300 rounded-md p-4"
                 ...
                 <div className="flex flex-col gap-2">
                    <label className="text-sm text-gary-700">Verification Code</label>
                    <input
                     type="text"
                      name="emailCode" 
                      placeholder="Code"
                    ...
                    { mode === MODE.LOGIN || mode === MODE.REGISTER ? (
                         <div className="flex flex-col gap-2">
                    <label className="text-sm text-gary-700">Password</label>
                    <input
                     type="password"
                      name="password" 
                 ...
                 <button className="bg-pixel text-white p-2 rounded-md disabled:bg-pink-200 disabled:cursor-not-allowed"
                 disabled={isLoading}
                 >
