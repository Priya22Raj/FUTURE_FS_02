      ...
      <div className="w-full md:w-1/2">
        ...
        <form action={updateUser} className="mt-12 flex flex-col gap-4">
          ...
          <input
            type="text"
            name="username"
            placeholder={user.member?.profile?.nickname || "priit"}
          ...
          <input
            type="text"
            name="firstName"
            placeholder={user.member?.contact?.firstName || "Priya"}
            className="ring-1 ring-gray-300 rounded-md p-2 max-w-96"
          />
          ...
          <input
            type="text"
            name="lastName"
            placeholder={user.member?.contact?.lastName || "Raj"}
            className="ring-1 ring-gray-300 rounded-md p-2 max-w-96"
          />
          ...
          <input
            type="email"
            name="email"
            placeholder={user.member?.loginEmail || "rajpriya4439@gmail.com"}
            className="ring-1 ring-gray-300 rounded-md p-2 max-w-96"
          />
          <UpdateButton />
        </form>
